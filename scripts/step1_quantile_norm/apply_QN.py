...
def parseArguments():
    ...
    parser.add_argument('raw_counts_file',help="matrix file gene (17995 x samples)", type=str)
    parser.add_argument('qn_mean_file',   help="trained QN model", type=str)
...
def main(LineArgs):
    ...
    raw_df = pd.read_csv(raw_counts_file, header='infer', sep="\t", index_col=0)
