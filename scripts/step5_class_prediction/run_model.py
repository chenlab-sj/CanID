...
def main(LineArgs):
    ...
    # Make Predictions one at a time to avoid Value Error: Input X contains NaN
    
    # Make Predictions
    #y_test_pred = clf.predict(X_test_std)
    #y_test_prob_array = clf.predict_proba(X_test_std)
    #y_test_proba = [x.max() for x in y_test_prob_array]
