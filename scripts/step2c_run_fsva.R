...
#    model_file="SVA_model" testDataFile="QN_normalized_test_file" outprefix="solid_sjInternal"' run_fSVA.R fSVA.out#
#                                                                                                                   #
#####################################################################################################################
...
fsvaobj = fsva(trainMatrix, trainMod, trainSv, testMatrix, method = "fast")

train_output = paste(outprefix, "_train_fsva_expression.txt", sep="")
test_output  = paste(outprefix, "_test_fsva_expression.txt", sep="")
